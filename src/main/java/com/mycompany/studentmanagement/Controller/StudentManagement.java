...
import com.mycompany.studentmanagement.Common.Library;
import java.util.ArrayList;
import java.util.Collections;
import com.mycompany.studentmanagement.Model.CourseOfStudent;
import com.mycompany.studentmanagement.Model.Report;
import com.mycompany.studentmanagement.Model.Student;
import com.mycompany.studentmanagement.View.Menu;
import com.mycompany.studentmanagement.View.Validation;
    ...
    String name;
        int id = l.getInt("Enter Student Id (1-1000)", 1, 1000);
        if (!checkID(list_s, id)) {
            name = l.getString("Enter Student name: ");
            list_s.add(new Student(id, name));
        }
        else System.out.println("This ID exist");
        int semester = l.getInt("Enter semester (1-10)", 1, 10);
    ...
    public ArrayList<Student> listByName(ArrayList<Student> list_s) {
        ...
        for (Student s : list_s) {
            if (s.getName().toLowerCase().contains(name1)) {
                list_Found.add(s);
            }
        }
        return list_Found;
    ...
    public void update_Delete() {
        ...
        if (list_ById.isEmpty() || list_ById_cs.isEmpty()) {
            ...
            System.out.println("ID found. Do you want to update or delete?");
    ...
    public void report() {
        ...
        for (CourseOfStudent cs : list_cs) {
            ...
            if (val.checkReport(list_Rp, id, courseName)) {
